...
**来源:** OWASP Top 10 (2021) + SCALE security-audit 技能格式  
**版本:** 1.0.0  
**用途:** LynxSec auditor.py 的规则化第一轮过滤, LLM 做第二轮语义分析。
...
- [ ] 错误消息不暴露内部信息
- [ ] Debug 模式已禁用
- [ ] HTTP 安全头完整: CSP / X-Frame-Options / X-Content-Type-Options
...
auditor.py 加载此文件作为审计基线:
1. 对每个确认漏洞, 勾选对应的 OWASP 分类
2. LLM 基于此 checklist 做补充分析 (非 checklist 覆盖的漏洞类型)
3. 最终报告标注每个漏洞的 OWASP 分类
